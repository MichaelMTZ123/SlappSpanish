...
export default function LearnHub({ 
    ...
    return (
        <div className="p-4 sm:p-8 h-full flex flex-col items-center justify-center">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-white drop-shadow-sm mb-4 text-center">{t('learning')} {t('hub')}</h1>
            <p className="text-lg text-gray-700 dark:text-gray-200 mb-12 text-center font-bold">{t('choosePath')}</p>
            <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
                <div id="learn-online-card" onClick={() => setView('online')} className="glass-panel p-8 rounded-3xl shadow-xl cursor-pointer hover:scale-105 transition-transform flex flex-col items-center text-center border-2 border-white/40">
                ...
                <div id="learn-path-card" onClick={() => setView('lessons')} className="glass-panel p-8 rounded-3xl shadow-xl cursor-pointer hover:scale-105 transition-transform flex flex-col items-center text-center border-2 border-white/40">
